...
model and query language activity in databases.
We
...
already solved.
Furthermore, the use of higher-level
...
siasm from the developer community.
Hadoop died
...
rowly focused applications, like caching and storing ses-
...
as a higher-level application.
One of the ﬁrst stan-
...
ment.
Examples of this transition are Amazon’s Dy-
...
transactions.
There are dozens of such systems, of
...
SQL is ﬁne for some things).
Adding SQL and ACID to a NoSQL DBMS lowers
their intellectual distance from RDBMSs.
The main
...
ner.
Since then, Google rewrote Spanner to remove
...
tectures.
Cassandra replaced their Thrift-API with a
...
as their internal search library.
These systems offer
...
results in signiﬁcant downtime.
...
ences via middleware that exposes a uniﬁed interface.
...
nomic sequencing and computational ﬂuid dynamics.
...
kdb+ [34].
Newer array DBMSs include SciDB [54,
191] and TileDB [76]. HDF5 [29] and NetCDF [46] are
popular array ﬁle formats for scientiﬁc data.
...
The difﬁculty arises from storing multi-dimensional ar-
...
ordered rasters was in 1993 [155].
An early exam-
ple of this was Illustra’s temporal (one-dimensional)
data plugin [31].
SQL:1999 introduced limited sup-
port for single-dimension, ﬁxed-length array data types.
...
To avoid brute force scans for ﬁnding the most sim-
...
ter (post-ﬁlter) the vector search.
...
expanded their APIs to support vector search.
Other
...
to add their own vector search extensions.
In 2023,
...
extensibility).
Meanwhile, relational incumbents will
...
supports key/value labels for nodes and edges.
RDF
...
The ﬁrst category of systems are for operational /
...
determination. Algorithm choice and data representa-
...
the underlying system topology.
However, previous
...
forms a leading graph DBMS by up to 10⇥[196]. This
...
RM systems or are only used for speciﬁc problems.
...
• Array Databases: Scientiﬁc applications will con-
...
These ideas range from terriﬁc to questionable, and we
...
2.
Organizations retain everything as long as they can
afford the storage — think terabytes to petabytes.
3.
Queries typically only access a small subset of at-
...
gine executes operators once per row.
In contrast, a
...
dependent companies (e.g., Snowﬂake [121]).
...
Generally, the ﬁrst two ideas are called “serverless
computing”, and was introduced for cloud-native DBMSs
by Snowﬂake [121].
Other vendors have moved or
...
expensive.
Cloud platforms are big time-sharing ser-
...
trends for all their customers: they can monitor unex-
...
With a data lake architecture, applications upload ﬁles
to a distributed object store, bypassing the traditional
route through the DBMS [167].
Users then execute
...
completely lack statistics on newly ingested data ﬁles.
...
The ﬁrst was in-memory DBMSs, including H-Store [144,
...
bad performance on multi-node transactions.
Some
...
Netezza was one of the ﬁrst FPGA-based DBMSs
...
rendering the hardware’s parallelization beneﬁts moot.
...
has custom components for in-memory shufﬂes [89].
...
Amazon built QLDB after ﬁnding no compelling use
...
• Cloud Databases: The cloud has upended the con-
ventional wisdom on how to build scalable DBMSs.
Except for embedded DBMSs, any product not start-
...
• Blockchain Databases: An inefﬁcient technology
...
to ﬁx the engineering debt they accumulated earlier.
...
engineers who make new internal systems, even if ex-
...
The impact of AI/ML on DBMSs will be signiﬁcant.
...
databases/graphs/sql-graph-overview, 2021.
[4] Georaster in oracle database.
https://www.oracle.com/a/
...
integrated-vector-database-augments-generative-ai-
2023-09-19/, sep 2023.
...
[29] The hdf5 library & ﬁle format.
...
[50] Oracle graph database.
https://www.oracle.com/database/
graph/, 2024.
[51] PGQL – Property Graph Query Language.
https://pgql-
lang.org/, 2024.
[52] Oracle
Text.
...
[54] Paradigm4 platform overview.
...
[64] PRQL – A Proposal for a Better SQL.
https://prql-
lang.org/, 2024.
...
[88] K. Affolter, K. Stockinger, and A. Bernstein.
A compara-
tive survey of recent natural language interfaces for databases.
VLDB J., 28(5):793–819, 2019.
doi: 10.1007/s00778-019-
00567-8.
[89] H. Ahmadi. In-memory query execution in google bigquery.
https://cloud.google.com/blog/products/bigquery/in-
memory-query-execution-in-google-bigquery, Aug 2016.
...
source-postgresql-on-steroids-swarm64-database-
acceleration-software-for-performance-improvement-
and-analytics/, apr 2023.
...
Amazon redshift re-invented. In Proceedings of the 2022 Inter-
national Conference on Management of Data, SIGMOD ’22,
pages 2205–2217, 2022. doi: 10.1145/3514221.3526045.
[95] M. Aslett.
How will the database incumbents respond to
NoSQL and NewSQL? The 451 Group, April 2011.
[96] M. Aslett. Ten years of NewSQL: Back to the future of dis-
tributed relational databases. The 451 Group, June 2021.
[97] S. Babu and P. Bizarro. Adaptive query processing in the look-
ing glass. In CIDR, pages 238–249, January 2005.
...
In Proceedings of the 2018 International Conference on Man-
...
[106] P. A. Boncz, M. Zukowski, and N. Nes. Monetdb/x100: Hyper-
...
[112] S. Chaudhuri and G. Weikum. Rethinking database system ar-
...
olap-cube/, January 2020.
[114] M. Chock, A. F. Cardenas, and A. Klinger. Database struc-
...
RJ909, 1971.
[117] W. W. W. Consortium. Overview of sgml resources.
https:
...
C. Taylor, R. Wang, and D. Woodford.
Spanner: Google’s
...
national Conference on Management of Data, SIGMOD ’16,
pages 215–226, 2016. doi: 10.1145/2882903.2903741.
[122] J. Dean and S. Ghemawat. MapReduce: Simpliﬁed data pro-
...
[123] J. Dean and S. Ghemawat. Mapreduce: A ﬂexible data process-
ing tool. Commun. ACM, 53(1):72–77, Jan. 2010.
[124] A. Dearmer. Storing apache hadoop data on the cloud - hdfs
vs. s3.
https://www.xplenty.com/blog/storing-apache-
hadoop-data-cloud-hdfs-vs-s3/, November 2019.
[125] G. DeCandia, D. Hastorun, M. Jampani, G. Kakulapati, A. Lak-
...
M. Wu, and F. Zemke.
Graph pattern matching in gql and
sql/pgq.
In Proceedings of the 2022 International Confer-
ence on Management of Data, SIGMOD ’22, pages 2246–2258,
...
[128] C. Diaconu, C. Freedman, E. Ismert, P. Larson, P. Mit-
tal, R. Stonecipher, N. Verma, and M. Zwilling.
Hekaton:
SQL server’s memory-optimized OLTP engine.
In Proceed-
ings of the ACM SIGMOD International Conference on Man-
agement of Data, pages 1243–1254, 2013.
doi: 10.1145/
2463676.2463710.
...
[130] J. Fan, A. G. S. Raj, and J. M. Patel. The case against special-
...
[132] M. Freitag, M. Bandle, T. Schmidt, A. Kemper, and T. Neu-
mann. Adopting worst-case optimal joins in relational database
systems.
Proc. VLDB Endow., 13(12):1891–1904, jul 2020.
doi: 10.14778/3407790.3407797.
[133] H. Fu, C. Liu, B. Wu, F. Li, J. Tan, and J. Sun. Catsql: To-
wards real world natural language to sql applications.
Proc.
VLDB Endow., 16(6):1534–1547, feb 2023.
doi: 10.14778/
3583140.3583165.
[134] S. Ghemawat, H. Gobioff, and S.-T. Leung. The google ﬁle
system. SIGOPS Oper. Syst. Rev., 37(5):29–43, oct 2003. ISSN
0163-5980. doi: 10.1145/1165389.945450.
[135] J. Gray, A. Bosworth, A. Layman, and H. Pirahesh.
Data
...
[136] S. Gupta, S. Rahnama, J. Hellings, and M. Sadoghi.
Re-
silientdb:
...
[143] A. Jindal, S. Madden, M. Castellanos, and M. Hsu. Graph ana-
lytics using vertica relational database. In 2015 IEEE Interna-
tional Conference on Big Data, pages 1191–1200, 2015.
...
tributed main memory transaction processing system.
Proc.
VLDB Endow., 1(2):1496–1499, aug 2008.
doi: 10.14778/
1454159.1454211.
...
piled and vectorized queries but were afraid to ask.
Proc.
...
to ﬁx it. SIGMOD Rec., 24(3):92–97, 1995.
...
In Proceedings of the 2021 International Conference on Man-
...
[158] C. McDonnell.
The graph-relational database,
deﬁned.
https://www.edgedb.com/blog/the-graph-relational-
database-defined, March 2022.
...
ence, volume 445, pages 51–56, 2010.
[160] F. McSherry.
Scalability!
but at what cost?
http:
...
[163] P. Menon, A. Ngom, T. C. Mowry, A. Pavlo, and L. Ma. Per-
...
[166] D. Misev and P. Baumann.
Sql support for multidimen-
sional arrays.
Technical Report 34, Jacobs University, July
2017.
...
3352063.3352116.
[168] H. Q. Ngo, C. Ré, and A. Rudra.
Skew strikes back: New
...
[170] M. A. Olson, K. Bostic, and M. I. Seltzer. Berkeley DB. In Pro-
ceedings of the FREENIX Track: 1999 USENIX Annual Tech-
nical Conference, pages 183–191, 1999.
[171] A. Pavlo and M. Aslett. What’s really new with newsql? SIG-
MOD Record, 45(2):45–55, Sep 2016.
...
ment systems. IEEE Data Eng. Bull., 42(2):32–46, 2019.
...
[176] P. Pedreira, O. Erling, K. Karanasos, S. Schneider, W. McK-
...
3407790.3407807.
[178] D. Petkovic. SQL/JSON standard: Properties and deﬁciencies.
...
[180] M. Raasveldt and H. Mühleisen. Duckdb: An embeddable ana-
...
[181] M. Rocklin. Dask: Parallel computation with blocked algo-
...
Found.
Trends Databases, 12(2-3):69–220, 2023.
doi:
10.1561/
1900000069.
[183] S. Sakr, A. Bonifati, H. Voigt, A. Iosup, K. Ammar, R. An-
...
[184] G. Salton and M. E. Lesk. The smart automatic document re-
...
national Conference on Management of Data, SIGMOD ’14,
pages 337–348, 2014. doi: 10.1145/2588555.2595637.
[187] M. Stonebraker.
The case for polystores.
https://
wp.sigmod.org/?p=1629, 2015.
[188] M. Stonebraker and J. Hellerstein. Readings in Database Sys-
tems, chapter What Goes Around Comes Around, pages 2–41.
4th edition, 2005.
...
[193] Z. Sun, X. Zhou, and G. Li. Learned index: A comprehen-
...
P. Mattis.
Cockroachdb: The resilient geo-distributed SQL
...
Efﬁcient property graph queries in an analytical rdbms.
In CIDR, 2023.
URL https://www.cidrdb.org/cidr2023/
papers/p66-wolde.pdf.
[197] A. Thusoo, J. S. Sarma, N. Jain, Z. Shao, P. Chakka, N. Zhang,
S. Antony, H. Liu, and R. Murthy.
...
[198] E. Totoni, T. A. Anderson, and T. Shpeisman. HPAT: high per-
...
[199] T. Trautmann.
Understanding
the document-relational
database.
https://fauna.com/blog/what-is-a-document-
relational-database, September 2021.
...
national Conference on Management of Data, SIGMOD ’17,
...
timization: a comprehensive experimental evaluation.
Proc.

...
6 Exploiting a relation includes query, update, and delete. elements
382 Communications of the ACM
...
386 Communications of the AMC
The relations al2 (P), 7r12 (Q), 7r12 (R ) are complexlo relations
...
IO A binary relation is complex if neither it nor its converse is a
function.
Volume 13 / Number 6 / June, 1970
...
which will have the effect of introducing (2, j) into al2 (Q)
and (5, j) in W(R). On the other hand, the input (2, 5)
...
Acknowledgment. It was C. T. Davies of IBM Pough-
keepsie who convinced the author of the need for data
independence in future information systems. The author
wishes to thank him and also F. P. Palermo, C. P. Wang,
E. B. Altman, and M. E. Senko of the IBM San Jose Re-
search Laboratory for helpful discussions.
...
view in Automatic Programming 6, 13, Pergamon Press,
...
10. FELDMAN, J. A., AND ROVNER, P. D. An Algol-based associ-
ative language. Stanford Artificial Intelligence Rep. AI-66,
Aug. 1, 1968.
Communications of the ACM 38’7
